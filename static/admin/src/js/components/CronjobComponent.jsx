        ...
        <div className="mb-4">
            ...
            {frequency === "hourly" && (
                <div className="mb-4">
                    ...
                    {enableHourlyInterval && (
                        <Form.Group controlId="hourlyInterval" className="mb-2">
            ...
            {frequency === "daily" && (
                <div className="mb-4">
                    ...
                    {enableDailyInterval && (
                        <Form.Group controlId="dailyInterval" className="mb-2">
                            <Form.Label className="font-semibold">
                                Every N Days
                            </Form.Label>
                            <Form.Control
            ...
            <div className="mt-4">
                <strong>Generated Cronjob:</strong> {value || "No Schedule Set"}
